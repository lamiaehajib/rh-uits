...
.badge-info { background: rgba(59, 130, 246, 0.2); color: #1e40af; }
.badge-success { background: rgba(34, 197, 94, 0.2); color: #166534; }
                ...
                <div class="card-body" style="padding: 2.5rem;">
                    <form action="{{ route('admin.projets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="statut_projet" class="form-label">Statut <span class="text-danger">*</span></label>
                                    <select class="form-control form-select @error('statut_projet') is-invalid @enderror" 
                                            id="statut_projet" 
                                            name="statut_projet" 
                                            required>
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted" style="margin-top: 0.8rem; color: #6b7280;">
                                <i class="fas fa-info-circle"></i> Formats acceptés: PDF, DOC, DOCX, JPG, PNG (Max: 5MB)
                            </small>
                            @error('fichier')
                        ...
                        <div class="form-group mb-0">
                            ...
                            <a href="{{ route('admin.projets.index') }}" class="btn-secondary-custom" style="margin-left: 1rem;">
        ...
        <div class="col-lg-4">
            <div class="glass-card help-card mb-4">
                ...
                <div class="card-body" style="padding: 2rem;">
                    <h6 style="font-weight: 700; color: var(--primary-color); margin-bottom: 1.2rem;">Conseils pour créer un projet:</h6>
                    <ul class="help-list">
                    ...
                    <h6 style="font-weight: 700; color: var(--primary-color); margin-bottom: 1.2rem;">Statuts disponibles:</h6>
                    <div>
                        <div class="status-badge badge-warning">
                            <i class="fas fa-play-circle"></i>
                            En Cours
                        </div>
                        <small style="display: block; color: #6b7280; margin-bottom: 0.5rem;">Projet actif en développement</small>
                        
                        <div class="status-badge badge-info">
                            <i class="fas fa-pause-circle"></i>
                            En Attente
                        </div>
                        <small style="display: block; color: #6b7280; margin-bottom: 0.5rem;">Projet temporairement suspendu</small>
                        
                        <div class="status-badge badge-success">
                            <i class="fas fa-check-circle"></i>
                            Terminé
                        </div>
                        <small style="display: block; color: #6b7280; margin-bottom: 0.5rem;">Projet livré avec succès</small>
