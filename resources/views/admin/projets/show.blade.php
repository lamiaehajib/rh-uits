                ...
                <div class="card-body" style="padding: 2.5rem;">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            ...
                            <small class="text-muted d-block mt-1">{{ $projet->client->email }}</small>
                        </div>
                    </div>
                    ...
                    <div class="card-body" style="padding: 2.5rem;">
                        <div class="progress-container">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span style="font-weight: 700; color: var(--primary-color); font-size: 1.1rem;">Progression globale</span>
                                <span style="font-weight: 800; font-size: 1.5rem; color: var(--primary-color);">{{ number_format($pourcentageGlobal, 1) }}%</span>
                            </div>
                        ...
                        <h6 style="color: var(--primary-color); font-weight: 700; margin-bottom: 1.5rem; font-size: 1.1rem;">Détails des avancements:</h6>
                        <div>
                            @foreach($projet->avancements->sortBy('created_at') as $avancement)
                                <div class="avancement-item">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div style="flex: 1;">
                                            <h6 style="color: var(--primary-color); font-weight: 700; margin-bottom: 0.5rem;">{{ $avancement->titre }}</h6>
                                            <p style="color: #4b5563; margin-bottom: 0.8rem; line-height: 1.5;">{{ $avancement->description }}</p>
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-card">
                ...
                <div class="card-body" style="padding: 1.5rem;">
                    ...
                    @if($projet->statut_projet !== 'terminé')
                        <button type="button" class="action-btn btn-complete" onclick="marquerTermine({{ $projet->id }})">
                            <i class="fas fa-check"></i> Marquer comme terminé
                        </button>
                    @endif
                    
                    <button type="button" class="action-btn btn-delete" onclick="confirmerSuppression({{ $projet->id }})">
            ...
            <div class="sidebar-card">
                ...
                <div class="card-body" style="padding: 1.5rem;">
                    ...
                    @if($projet->date_debut && $projet->date_fin)
                        <div style="text-align: center; padding: 1.5rem; background: var(--gradient-light); border-radius: 16px; border: 1px solid rgba(194, 24, 91, 0.1);">
                            <h6 style="color: var(--primary-color); font-weight: 700; margin-bottom: 0.5rem;">Durée du projet</h6>
            ...
            <div class="sidebar-card">
                ...
                <div class="card-body" style="padding: 2rem; text-align: center;">
                    ...
                    <h6 style="color: var(--primary-color); font-weight: 700; margin-bottom: 0.5rem;">{{ $projet->client->name }}</h6>
                    <p style="color: #6b7280; margin-bottom: 1.5rem; font-weight: 500;">{{ $projet->client->email }}</p>
                    
                    @if($projet->client->phone)
                        <a href="tel:{{ $projet->client->phone }}" class="btn-download" style="width: 100%; justify-content: center;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 2rem;">
                <div style="text-align: center; margin-bottom: 1.5rem;">
                    <i class="fas fa-trash-alt" style="font-size: 3rem; color: var(--accent-color); margin-bottom: 1rem;"></i>
                </div>
                <p style="color: #4b5563; font-size: 1.1rem; line-height: 1.6;">Êtes-vous sûr de vouloir supprimer ce projet ? Cette action est irréversible.</p>
                <div style="background: rgba(239, 68, 68, 0.1); padding: 1rem; border-radius: 12px; border-left: 4px solid var(--accent-color);">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn-gradient" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);">
...
function createParticle() {
    ...
    if (header) {
        ...
        particle.animate([
            ...
            { transform: 'translateY(-240px) scale(0)', opacity: 0 }
        ], {
            duration: 4000,
            easing: 'ease-out'
...
document.querySelectorAll('.glass-card, .sidebar-card').forEach(card => {
