<x-app-layout>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.projets.index') }}">Projets</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.projets.show', $projet) }}">{{ Str::limit($projet->titre, 20) }}</a>
                        </li>
            ...
            <div class="alert alert-custom alert-dismissible fade show" role="alert">
                <div style="display: flex; align-items: flex-start; gap: 12px;">
                    <i class="fas fa-exclamation-triangle"
                        style="color: var(--accent-color); font-size: 1.2rem; margin-top: 2px;"></i>
                    <div style="flex: 1;">
                        <h6
                            style="color: var(--accent-color); margin-bottom: 0.8rem; font-weight: 700;">Erreurs de
                            validation :</h6>
                ...
                <button type="button" class="btn-close" data-bs-dismiss="alert"
                    style="color: var(--accent-color);"></button>
            </div>
        @endif
                ...
                <div class="glass-card">
                    ...
                    <div class="card-body" style="padding: 2.5rem;">
                        <form action="{{ route('admin.projets.update', $projet) }}" method="POST"
                            enctype="multipart/form-data" id="projetForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="titre" class="form-label">
                                        <i class="fas fa-heading"></i> Titre du
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">
                                        <i class="fas fa-users"></i> Clients <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div
                                        class="clients-checkbox-container @error('client_ids') is-invalid @enderror">
                                        @foreach($clients as $client)
                                            <div class="client-checkbox-item">
                                                ...
                                                <label
                                                    for="client_{{ $client->id }}" class="client-info">
                                                    <div
                                                        class="client-name">{{ $client->name }}</div>
                                                    <div
                                                        class="client-email">{{ $client->email }}</div>
                                                </label>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="statut_projet" class="form-label">
                                        <i class="fas fa-flag"></i> Statut <span
                                            class="text-danger">*</span>
                                    </label>
                                    <select
                                        class="form-select @error('statut_projet') is-invalid @enderror"
                                        id="statut_projet"
                                        name="statut_projet"
                                        required>
                                        ...
                                        <option value="annulé" {{ old('statut_projet', $projet->statut_projet) == 'annulé' ? 'selected' : '' }}>
                                            Annulé</option>
                                    </select>
                                    @error('statut_projet')
                                        <div class="invalid-feedback">{{ $message }}
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-text">
                                        <i class="fas fa-info-circle"></i> <span
                                            id="charCount">{{ strlen($projet->description ?? '') }}</span> caractères
                                    </div>
                                </div>
                                    ...
                                    @if($projet->fichier)
                                        <div class="mb-2">
                                            <div class="alert-info-custom">
                                                <i
                                                    class="fas fa-file text-primary"></i>
                                                <div style="flex: 1;">
                                                    <strong>Fichier actuel
                                                        :</strong>
                                                    <a
                                                        href="{{ route('admin.projets.download', $projet) }}"
                                                        class="btn-download">
                                                        <i
                                                            class="fas fa-download"></i> Télécharger le fichier du projet
                                                    </a>
                                                </div>
                                                <button type="button"
                                                    class="btn btn-outline-danger btn-sm" onclick="supprimerFichier()"
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <hr
                                        style="border: none; height: 1px; background: rgba(194, 24, 91, 0.1); margin: 2rem 0;">
                                    <div
                                        class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <a
                                                href="{{ route('admin.projets.show', $projet) }}"
                                        ...
                                        <div style="display: flex; gap: 1rem;">
                                            <button type="button"
                                                class="btn-outline-gradient" onclick="previewChanges()">
            ...
            <div class="col-lg-4">
                <div class="sidebar-card">
                    ...
                    <div class="card-body" style="padding: 1.5rem;">
                        <h6
                            style="color: var(--primary-color); font-weight: 700; margin-bottom: 1rem;">Conseils pour la
                            modification :</h6>
                        <ul class="help-list">
                ...
                <div class="sidebar-card">
                    ...
                    <div class="card-body" style="padding: 1.5rem;">
                        <div class="info-row">
                            ...
                            <span
                                class="info-value">{{ $projet->created_at->format('d/m/Y') }}</span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Modifié le :</span>
                            <span
                                class="info-value">{{ $projet->updated_at->format('d/m/Y') }}</span>
                        </div>
                        <div class="info-row">
                        ...
                        @if($projet->avancements->count() > 0)
                            <div class="info-row">
                                ...
                                <span
                                    class="info-value">{{ number_format($projet->avancements->avg('pourcentage') ?? 0, 1) }}%</span>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body" style="padding: 1.5rem;">
                        <div class="alert-warning-custom">
                            ...
                            <small style="color: #92400e; line-height: 1.4;">
                                Les modifications seront appliquées immédiatement et le
                                client sera potentiellement notifié selon la configuration du système.
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-eye"
                            style="color: var(--primary-color);"></i> Aperçu des modifications</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="previewContent">
                    </div>
                <div class="modal-footer"
                    style="border-top: 1px solid rgba(194, 24, 91, 0.1); padding: 1.5rem;">
                    <button type="button" class="btn-secondary-custom" data-bs-dismiss="modal">
                        <i class="fas fa-times"></i> Fermer
                    </button>
                    <button type="button" class="btn-gradient"
                        onclick="document.getElementById('projetForm').submit()">
    ...
    <script>
        ...
        function previewChanges() {
            ...
            // Client
            const clientsChecked = document.querySelectorAll('input[name="client_ids[]"]:checked');
            let clientsList = '';
            clientsChecked.forEach(client => {
                const clientName = document.querySelector(`label[for="client_${client.value}"] .client-name`).textContent;
                const clientEmail = document.querySelector(`label[for="client_${client.value}"] .client-email`).textContent;
                clientsList += `<li><strong>${clientName}</strong> (${clientEmail})</li>`;
            });

            previewHTML += `
            <div class="col-md-12 mb-3">
                <div class="preview-item">
                    <div class="preview-label">Clients assignés</div>
                    <div class="preview-value"><ul>${clientsList}</ul></div>
                </div>
            </div>`;
            ...
            if (formData.get('description')) {
                ...
                <div class="col-12 mb-3">
                    <div class="preview-item">
                        ...
                        <div class="preview-value">${formData.get('description').replace(/\n/g, '<br>')}</div>
                    </div>
                </div>`;
            }
        ...
        document.getElementById('projetForm').addEventListener('submit', function (e) {
            ...
            const clients = document.querySelectorAll('input[name="client_ids[]"]:checked');
            const dateDebut = document.getElementById('date_debut').value;

            if (!titre || clients.length === 0 || !dateDebut) {
                e.preventDefault();
        ...
        function createParticle() {
            ...
            particle.style.cssText = `position: absolute; width: 4px; height: 4px; background: rgba(255, 255, 255, 0.3); border-radius: 50%; pointer-events: none; z-index: 1;`;
