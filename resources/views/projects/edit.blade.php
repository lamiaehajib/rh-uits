<x-app-layout>
    <head>
        ...
        <title>{{ __('Modifier le Projet') }}</title>
        ...
        <style>
            ...
            .btn-project-update { /* Changed from create to update */
            ...
            .checkbox-button-group {
                ...
                border: 1px solid #d1d5db; /* gray-300 - matches input-group-custom border */
                border-radius: 0.375rem; /* rounded-md - matches input-group-custom border-radius */
                padding: 0.5rem; /* Add some padding around the buttons */
                box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); /* shadow-sm */
                transition: all 0.2s ease-in-out;
            }

            .checkbox-button-group:focus-within {
                border-color: #D32F2F; /* primary-red */
                box-shadow: 0 0 0 3px rgba(211, 47, 47, 0.2); /* ring-primary-red with opacity */
            }
            ...
            .checkbox-button span {
                ...
                align-items: center;
                gap: 0.5rem;
                /* No extra padding/border here, it's handled by .checkbox-button */
                transition: all 0.2s ease-in-out;
            }
    ...
    <body>
        @can("project-edit")
            ...
            <h2 class="font-semibold text-2xl text-gray-800 leading-tight border-b-2 border-secondary-purple pb-3 mb-6 animate-fade-in delay-100">
                <i class="fas fa-project-diagram mr-3 text-secondary-purple"></i> {{ __('Modifier le Projet') }}
            </h2>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg card-hover-scale animate-fade-in">
                    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-2xl font-bold text-secondary-purple">Modifier le Projet: {{ $project->titre }}</h3>
                        ...
                        <form action="{{ route('projects.update', $project->id) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="text" name="titre" id="titre" class="form-control-custom @error('titre') border-primary-red @enderror" value="{{ old('titre', $project->titre) }}" required>
                                    </div>
                                    @error('titre')
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="text" name="nomclient" id="nomclient" class="form-control-custom @error('nomclient') border-primary-red @enderror" value="{{ old('nomclient', $project->nomclient) }}" required>
                                    </div>
                                    @error('nomclient')
                                        <div class="invalid-feedback-custom">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="text" name="ville" id="ville" class="form-control-custom @error('ville') border-primary-red @enderror" value="{{ old('ville', $project->ville) }}" required>
                                    </div>
                                    @error('ville')
                                        <div class="invalid-feedback-custom">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="checkbox-button-group">
                                        @php
                                            $assignedUserIds = old('iduser', $project->users->pluck('id')->toArray());
                                        @endphp
                                        @foreach($users as $user)
                                            <label class="checkbox-button">
                                                <input type="checkbox" name="iduser[]" value="{{ $user->id }}" {{ in_array($user->id, $assignedUserIds) ? 'checked' : '' }}>
                                                <span>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="date" name="date_project" id="date_project" class="form-control-custom @error('date_project') border-primary-red @enderror" value="{{ old('date_project', $project->date_project) }}" required>
                                    </div>
                                    @error('date_project')
                                        <div class="invalid-feedback-custom">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <textarea name="bessoins" id="bessoins" rows="4" class="form-control-custom form-textarea-custom @error('bessoins') border-primary-red @enderror" required>{{ old('bessoins', $project->bessoins) }}</textarea>
                                    </div>
                                    @error('bessoins')
                                        <div class="invalid-feedback-custom">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="flex items-center justify-end mt-6 space-x-3">
                                <button type="submit" class="inline-flex items-center px-6 py-3 btn-project-update rounded-md font-bold text-sm text-white uppercase tracking-wider shadow-lg">
        ...
        @push('scripts')
            ...
            <script>
                $(document).ready(function() {
                    // No Select2 initialization needed for user assignment anymore.
                    // Any other page-specific JS can go here.
                });
            </script>
        @endpush
        @endcan
